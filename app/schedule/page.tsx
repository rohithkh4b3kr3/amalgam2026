          ...
          <div className="pl-5 pr-4 py-4">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
              ...
              <div className="shrink-0 sm:w-20 sm:text-right">
                ...
                <div className="font-display text-xs mt-0.5" style={{ color: "rgba(148,120,78,0.5)" }}>{event.endTime}</div>
              </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs leading-relaxed mb-2" style={{ color: "rgba(188,160,112,0.62)" }}>{event.description}</p>
                <div className="flex flex-wrap gap-3 text-[10px]" style={{ color: "rgba(148,120,76,0.5)" }}>
            ...
            return (
              <button key={d} onClick={() => setDay(d)}
                ...
                style={{
                  ...
                  color: active ? undefined : "rgba(162,135,88,0.6)",
                }}>
                {DAY_LABELS[d]}
              </button>
            );
