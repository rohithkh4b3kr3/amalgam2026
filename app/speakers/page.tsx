...
export default function SpeakersPage() {
  ...
  return (
    <div className="w-full min-h-screen pt-24" style={{ background: "#FFFFFF", color: "#1A0A00" }}>
      ...
      {/* ── Stats row ──────────────────────────────────────── */}
      <div className="border-y border-[rgba(255,107,0,0.12)] py-5" style={{ background: "rgba(255,250,244,0.97)" }}>
      ...
      <section className="relative max-w-7xl mx-auto px-6 py-20">
        ...
        <motion.div
          ...
          className="mb-14"
        >
          <h2 className="font-display text-3xl md:text-4xl font-light tracking-wide text-[#1A0A00]">
            FEATURED SPEAKERS
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
          {SPEAKERS.map((speaker, i) => (
            <motion.div
              ...
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(255,107,0,0.15)";
                (e.currentTarget as HTMLDivElement).style.background = "rgba(255,248,242,0.97)";
              }}
            >
              {/* Photo area */}
              <div className="aspect-square rounded-xl overflow-hidden mb-4 flex items-center justify-center"
                style={{ background: "rgba(255,235,220,0.8)" }}>
                {speaker.photo ? (
              ...
              {/* Info */}
              <h4 className="font-display font-semibold text-sm text-[#1A0A00] tracking-wide leading-snug mb-1">
                {speaker.name}
              </h4>
